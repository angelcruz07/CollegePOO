...
public class Main {
  public static void main(String[] args) {
    ...
    // System.out.printf("%.2f %s equivalen a %.2f %s%n", amount, mxn.getSymbol(),
    // result, usd.getSymbol());
    // break;
    // case 2:
    // System.out.println("Ingrese la cantidad en MXN");
    // amount = sc.nextDouble();
    ...
    SwingUtilities.invokeLater(new Runnable() {
      ...
      public void run() {
        ...
        frmConvert.setVisible(true); // Si FrmConvert es un JFrame o JPanel
      }
    });
  }
}
